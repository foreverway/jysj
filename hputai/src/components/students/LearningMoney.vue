...
:title="form1.type==1?'入款':'扣款'" :visible.sync="dialogVisible" width="500px" close-on-click-modal="false" >
  ...
  placeholder="请输入事由" v-model="form1.reason" ></el-input>
    </el-form-item>
  </el-form>
  <div slot="footer" class="dialog-footer">
    <el-button @click="dialogVisible = false">取 消</el-button>
    <el-button type="primary" style="background-color:#e6563a; border:none;" @click="dialogVisible = false,postfun()">确 定</el-button>
  </div>
</el-dialog>
