<template>
    <div class="main">
        <el-page-header @back="goBack" content="新建学员账户" style="margin-bottom:20px" >
</el-page-header>
<el-form ref="sizeForm" :model="sizeForm"  :rules="rules" label-width="100px" size="mini">
 ...
 <el-form-item label="升学目标">
  ...
  <el-form-item size="large">
    <el-button type="primary" style="background-color:#e6563a; border:none;"  autosize @click="onSubmit('sizeForm')">立即创建</el-button>
  ...
  export default {
    data() {
      ...
      return {
        ...
        sizeForm: {
         ...
         rules: {
          username: [ {  required: true, validator: students_check, trigger: 'blur' }],
          tel:[{ required: true, validator: students_check_phone, trigger: 'blur' }],
    ...
    methods: {
      ...
      onSubmit(formName) {
          ...
          if (valid) {
                this.$apis.students.students_add(this.sizeForm).then(res=>{
            if(res.data.code==1){
    this.$message({
          message: '添加成功',
          type: 'success'
