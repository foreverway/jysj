    ...
    <el-form ref="form" :model="form" :rules="rules" label-width="100px">
      ...
      <el-form-item label="海报:" style="width:500px">
        ...
        >
          ...
          <img :src="form.src_img" alt height="400" />
...
export default {
  ...
  methods: {
    getdata() {
      ...
      this.$apis.common.edit_share_config(parms).then(res => {
        if (res.data.code == 1) {
    ...
    onSubmit() {
      this.$apis.common.save_share_config(this.form).then(res => {
        if (res.data.code == 1) {
          this.loading = false;
          this.$message({
            message: "保存成功",
