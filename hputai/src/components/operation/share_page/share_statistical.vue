<template>
  <div class="so_main">
    <div class="so_main_left">
      <el-form :inline="true"  class="demo-form-inline">
        ...
        <el-select
          ...
          style="width:180px"
          class="so_input"
          v-model="form.share_config_id"
          filterable
          placeholder="请选择素材标题"
          @change="getadata"
        >
          <el-option v-for="item in sharelist" :key="item.id" :label="item.title" :value="item.id"></el-option>
        </el-select>
        <el-date-picker
    ...
    >
      ...
      <el-table-column align="center" label="查看时间">
        <template slot-scope="scope">
