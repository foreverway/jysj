...
<div class="so_main_left">
 <el-input class="so_input" v-model="form.search" @input="getadata" placeholder="请输入推广标题/学员姓名/创建人"></el-input>
...
<div class="so_main_right">
 ...
 <el-table-column
      ...
      <template slot-scope="scope">
          ...
          <p> <a :href="scope.row.src_img" target="_blank" :download="scope.row.uname+scope.row.title +'.png'">
...
<el-dialog title="预览" :visible.sync="dialogFormVisible3" width="475px" custom-class="yulan_height"  close-on-click-modal="false">
...
.so_main_left{float: left;    margin-bottom: 20px;}
.so_main_right{float: right;}
.yulan_height{height: 50vh;}

.hover_img_main{position: relative;}
.hover_img_show{display: node;position: absolute;}
