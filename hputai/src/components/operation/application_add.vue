  ...
  <el-cascader
   ...
   <el-form-item :inline="true" label="已选科目">
    ...
    <div class="add_ul_new"  v-for="(item,i) in editableTabs_1" :key="i">
     ...
     <p><el-input v-model.number=item.times  v-bind:id="'time' + i" placeholder="课时"></el-input></p>
     <p><el-input v-model.number=item.price  v-bind:id="'mach' + i" placeholder="单价(元)"></el-input></p>
  ...
  <el-form>
    <el-form-item label="上课地点"  v-model="radio">
     ...
     <el-form-item label="需求1">
          <el-input type="textarea" v-model="need_one"   maxlength="100"
  show-word-limit placeholder="学生排课项目、科目、考局（A-level必写）及课时"></el-input>
    </el-form-item>
    <el-form-item label="需求2">
          <el-input type="textarea" v-model="need_two" placeholder="学生学习需求是什么？（零基础先修、同步辅导、巩固复习、强化冲刺）" ></el-input>
    </el-form-item>
    <el-form-item label="需求3">
          <el-input type="textarea" v-model="need_three" placeholder="学生之前的学习经历和学习基础（之前在那里上的学？学习基础怎么样？）"></el-input>
    </el-form-item>
...
<div v-if="active==3" >
    ...
    提交成功<i class="el-icon-circle-check" type="success"></i>
      ...
      <el-link type="primary" href="./ApplicationAdd">查看排课需求列表<i class="el-icon-view el-icon--right" ></i> </el-link>
     </div>
